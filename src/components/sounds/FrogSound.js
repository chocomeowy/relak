...
const FrogSound = () => {
  ...
  const url = "https://dl.dropboxusercontent.com/s/seb6um06p522zzg/Frogs.mp3?dl=0";

  return (
    <Space direction="vertical" size={16} style={{ width: "100%" }}>
      <div>
        <Text strong style={{ fontSize: "18px", display: "block" }}>Frogs</Text>
        <Text type="secondary" style={{ fontSize: "12px" }}>Crickets and frogs at night.</Text>
      </div>
