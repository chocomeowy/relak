...
const SingingBowl = () => {
  ...
  const url = "https://dl.dropboxusercontent.com/s/kqemjjka17xcodk/SingingBowl.mp3?dl=0";

  return (
    <Space direction="vertical" size={16} style={{ width: "100%" }}>
      <div>
        <Text strong style={{ fontSize: "18px", display: "block" }}>Singing Bowl</Text>
        <Text type="secondary" style={{ fontSize: "12px" }}>Tibetan focus bowl.</Text>
      </div>
